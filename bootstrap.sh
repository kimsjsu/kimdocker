...
docker run -d --name c0 --network mycluster --ip 192.168.10.100 myimage:Dockerfile
docker run -d --name c1 --network mycluster --ip 192.168.10.101 myimage:Dockerfile
docker run -d --name c2 --network mycluster --ip 192.168.10.102 myimage:Dockerfile
